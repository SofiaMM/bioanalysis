...
import bioanalysis.dbMain.db.SpringBootMysqldbApplication;
import bioanalysis.dbMain.db.utils.BioanalysisImporter;

@RunWith(SpringRunner.class)
@SpringBootTest(classes= {SpringBootMysqldbApplication.class})
